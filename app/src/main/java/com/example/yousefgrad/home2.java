...
public class home2 extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        switchCompat=findViewById(R.id.switch1d);
        textView=(TextView)findViewById(R.id.textlocationnd);
...
flag=1;
        ...
        driverid = mFirebaseAuth.getCurrentUser().getUid();
        alone=findViewById(R.id.aloned);
        geocoder = new Geocoder(this, Locale.getDefault());
        alone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                   Intent intToHome = new Intent(home2.this,onlineuser.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                if (listPoints.size() == 2) {
                    new FetchURL(home2.this).execute(getUrl(listPoints.get(0), listPoints.get(1), "driving"), "driving");
                }
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                DatabaseReference current_user_db = mDatabase.child(driverid);
                ...
                if(flag2==1 ) {
                    ...
                    current_user_db.child("driverid").setValue(driverid);
                ...
                new androidx.appcompat.app.AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(home2.this,
